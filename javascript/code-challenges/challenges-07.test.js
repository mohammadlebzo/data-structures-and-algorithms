...
const splitFoods = (recipe) => {
  let result = [];
  // Solution code here...
  recipe.ingredients.map(item => result.push(item.split(' ').slice(2, item.split(' ').length).join(' ')));
  return result;
};
...
const stepActions = (recipe) => {
  let result = [];
  // Solution code here...
  recipe.steps.map(item => result.push(item.split(' ')[0]));
  return result;
};
...
const removeEvenValues = (arr) => {
  // Solution code here...
  for (let i = 0; i < arr.length; i++) {if (arr[i] % 2 === 0) {arr.splice(i--, 1)}}
  return arr;
};
...
const removeLastCharacters = (str, numberOfCharacters) => {
  ...
  if (numberOfCharacters > str.length) {
    ...
    tempStr = str.slice(0, str.length-numberOfCharacters);
    return tempStr;
  }
};
...
const totalSumCSV = (str) => {
  let total = 0;
  // Solution code here...
  total = str.split(',').map(item => Number(item)).reduce((acc, item) => acc += item);
  return total;
};
...
const removeVowels = (str) => {
  // Solution code here...
  let tempStr = str.split('').filter(item => item.toLowerCase() ==='a'||item.toLowerCase() ==='e'||item.toLowerCase() ==='i'||item.toLowerCase() ==='o'||item.toLowerCase() ==='u' ? false : true).join('');
  return tempStr;
};
...
const extractVowels = (str) => {
  // Solution code here...
  let vowels = [];
  let tempStr = str.split('').filter(item => {
  ...
  let result = [tempStr, vowels.sort().join('')]
  return result;
};
