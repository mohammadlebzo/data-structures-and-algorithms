...
const firstLetters = (arr) => {
  // Solution code here...
  let tempArr = arr.map(item => item.charAt(0));
  return tempArr;
};
...
const findHappiness = (arr) => {
  // Solution code here...
  let tempArr = arr.filter(item => item.includes(':)') ? true : false);
  return tempArr;
};
...
const allHappy = (arr) => {
  // Solution code here...
  let isHappy = false;
  arr.length === 0 ? isHappy = true : isHappy = arr.reduce((acc, item) => item.includes(':)') === false ? acc = false : acc , true);
  return isHappy;
};
...
const findAnything = (arr, target) => {
  // Solution code here...
  let tempArr = arr.filter(item => item.includes(target) ? true : false);
  return tempArr;
};
...
const findEvery = (arr, target) => {
  // Solution code here...
  let isThere = arr.reduce((acc, item) => item.includes(target) === false ? acc = false : acc , true);
  return isThere;
};
...
const unenrollBrook = (arr) => {
  // Solution code here...
  let tempArr = [];
  arr.length === 0 ? [] : tempArr = arr.map(item => item.filter(element => element.includes('Brook') ? false : true));
  return tempArr;
};
...
const sortByDay = (arr) => {
  // Solution code here...
  let tempArr = [];
  daysOfWeek.forEach(element => tempArr.push(arr.filter(item => item.includes(element))));
  return tempArr;
};
...
const characterByIndex = (arr) => {
  // Solution code here...
  let tempArr = arr.map((item, idx) => item.charAt(idx));
  return tempArr;
};
